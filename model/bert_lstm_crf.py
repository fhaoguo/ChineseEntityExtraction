# coding=utf-8
# @FileName     :bert_lstm_crf.py
# @DateTime     :2022/2/14 15:12
# @Author       :Haoguo Feng
...
from model.bidirectional_dynamic_rnn import bidirectional_dynamic_rnn
...
class BertLSTMCRF(object):
    def __init__(self, config):
        ...
        # bert模型参数初始化的地方
        init_checkpoint = "bert_base/chinese_L-12_H-768_A-12/bert_model.ckpt"
        # 获取模型中所有的训练参数。
    ...
    def bert_embedding(self):
        # load bert embedding
        bert_config = modeling.BertConfig.from_json_file("bert_base/chinese_L-12_H-768_A-12/bert_config.json")  # 配置文件地址。
