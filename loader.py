...
from re_expr import detect_sentence_border, startwith_non_chinese
from utils import convert_single_example
from bert_base.bert import tokenization

tokenizer = tokenization.FullTokenizer(vocab_file='bert_base/chinese_L-12_H-768_A-12/vocab.txt', do_lower_case=True)
    ...
    for line in codecs.open(path, 'r', 'utf8'):
        ...
        if not line:
            if len(sentence) > 0:
                ...
                sentence = []
        elif detect_sentence_border(line) or \
                (len(sentence) > 32 and line.endswith("O") and startwith_non_chinese(line)):
            word = line.split()
